...
void watchy_ui_init_gen(const char * asset_path)
{
    ...
    static char subject_new_buf[UI_SUBJECT_STRING_LENGTH];
    static char subject_new_prev_buf[UI_SUBJECT_STRING_LENGTH];
    lv_subject_init_string(&subject_new,
                           subject_new_buf,
                           subject_new_prev_buf,
                           UI_SUBJECT_STRING_LENGTH,
                           "new"
                          );
    ...
    lv_xml_register_subject(NULL, "subject_new", &subject_new);
