...
lv_obj_t * settings_create(void)
{
    ...
    lv_obj_t * settings_main_list = lv_obj_create(lv_obj_0);
    lv_obj_set_name(settings_main_list, "settings_main_list");
    lv_obj_set_y(settings_main_list, 25);
    lv_obj_add_style(settings_main_list, &style_cont, 0);
    ...
    lv_obj_bind_flag_if_not_eq(lv_obj_1, &subject_settings_view, LV_OBJ_FLAG_HIDDEN, 1);
    ...
    lv_obj_bind_flag_if_not_eq(lv_obj_2, &subject_settings_view, LV_OBJ_FLAG_HIDDEN, 2);
    ...
    lv_obj_bind_flag_if_not_eq(lv_obj_3, &subject_settings_view, LV_OBJ_FLAG_HIDDEN, 3);
    lv_obj_t * a_date = lv_label_create(lv_obj_3);
    lv_obj_set_name(a_date, "a_date");
    lv_label_set_text(a_date, "Today");
    lv_obj_set_align(a_date, LV_ALIGN_TOP_MID);
    lv_obj_set_y(a_date, 0);
    
    lv_obj_t * bar_chart = lv_chart_create(lv_obj_3);
